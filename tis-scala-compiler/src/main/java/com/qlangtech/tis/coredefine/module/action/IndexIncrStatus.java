...
public class IndexIncrStatus extends K8SControllerStatus {
    ...
    /**
     * 是否可以基于Checkpoint恢复任务 <br/>
     * 可以基于checkpoint恢复任务的前提是，需要开启checkpoint，并且使用了持久化statebackend
     */
    private boolean restorableByCheckpoint;

    private String incrScriptMainFileContent;

    public boolean isRestorableByCheckpoint() {
        return this.restorableByCheckpoint;
    }

    public void setRestorableByCheckpoint(boolean restorableByCheckpoint) {
        this.restorableByCheckpoint = restorableByCheckpoint;
    }
