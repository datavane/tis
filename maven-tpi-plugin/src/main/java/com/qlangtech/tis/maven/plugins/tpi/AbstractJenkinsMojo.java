...
public abstract class AbstractJenkinsMojo extends AbstractMojo {
   ...
   // @Component
    ...
    @Component
    protected RepositorySystem artifactResolver;
    ...
    protected MavenArtifact wrap(Artifact a) {
        return new MavenArtifact(a, artifactResolver, artifactFactory, projectBuilder, remoteRepos, localRepository, session, project);
    }
}
