...
<config>
	...
	<query>
		<slowQueryThresholdMillis>800</slowQueryThresholdMillis>
	...
	<requestHandler name="/admin/file"
		class="org.apache.solr.handler.file.ShowFileRequestHandler">
	...
	<updateRequestProcessorChain name="ignore-commit-from-client"
		...
		<processor
			class="org.apache.solr.update.processor.TisDistributedUpdateProcessorFactory" />
