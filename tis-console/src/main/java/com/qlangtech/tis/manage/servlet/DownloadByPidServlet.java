...
public class DownloadByPidServlet extends DownloadServlet {
    ...
    private static final Pattern download_pattern = Pattern.compile(".+?/download/snid/(\\d+)/(" + replace(ConfigConstant.FILE_APPLICATION + "|" + ConfigConstant.FILE_DATA_SOURCE + "|" + ConfigConstant.FILE_SCHEMA + "|" + ConfigConstant.FILE_SOLR) + "|" + DownloadResource.JAR_NAME + ")");
