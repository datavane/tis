...
//  private static final Timeout ASK_TIMEOUT = Timeout.apply(30, TimeUnit.SECONDS);
  ...
  //                this.addErrorMessage(context, "DAG validation failed: " + String.join(", ", validationResult
  //                .getErrors()));
  //                return;
  //            }
  //
...
//    Integer instanceId = this.getInt("taskId");
//    WorkflowRuntimeStatus workflowRuntimeStatus = akkaClusterSupport.doQueryWorkflowStatus(instanceId);
//
//    this.setBizResult(context, workflowRuntimeStatus);
