...
public interface IPrimaryValRewrite {
  ...
  default boolean isDuplicateInExistEntities(PropertyType pk, String identityFieldVal) {
    if (StringUtils.isEmpty(identityFieldVal)) {
      throw new IllegalStateException("primary key:" + pk.propertyName() + " can not be empty");
    }
    return false;
  }

//  Function<IPropertyType, IdentityName>
}
