...
public class WorkFlowBuildHistoryDAOImpl extends BasicDAO<WorkFlowBuildHistory, WorkFlowBuildHistoryCriteria> implements IWorkFlowBuildHistoryDAO {
  ...
  @Override
  public boolean hasRunningInstance(DataXName name) {
    throw new UnsupportedOperationException("this method is used for http delegate com.qlangtech.tis.plugin.akka.DAORestDelegateFacade");
  }
  ...
  public WorkFlowBuildHistory selectByPrimaryKey(Integer id) {
    WorkFlowBuildHistory key = new WorkFlowBuildHistory();
    key.setId(id);
    WorkFlowBuildHistory record = (WorkFlowBuildHistory) this.load("work_flow_build_history"
  ...
  public WorkFlowBuildHistory loadFromWriteDB(Integer id) {
    WorkFlowBuildHistory key = new WorkFlowBuildHistory();
    key.setId(id);
    WorkFlowBuildHistory record = (WorkFlowBuildHistory) this.loadFromWriterDB("work_flow_build_history"
      + ".ibatorgenerated_selectByPrimaryKey", key);
    return record;
  }
