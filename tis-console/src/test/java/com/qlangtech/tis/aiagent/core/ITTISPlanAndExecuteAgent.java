...
public class ITTISPlanAndExecuteAgent {
    ...
    private static class TestAgentContext extends AgentContext {
        ...
        public TestAgentContext(String sessionId, PrintWriter sseWriter) {
    ...
    private static class CancellableAgentContext extends TestAgentContext {
        ...
        public CancellableAgentContext(String sessionId, PrintWriter sseWriter) {
            super(sessionId, sseWriter);
        }
    ...
    private static class FailingLLMProvider implements LLMProvider {
        ...
        @Override
        public LLMResponse chatJson(String prompt, String systemPrompt, String jsonSchema) {
            return chat(prompt, systemPrompt, 0.7);
        }
