 ...
 * @date 2020/04/13
 */
public enum OrderBillColEnum {

    ID("id", 12, true),
    ORDER_ID("order_id", 12, false),
    STATUS("status", 4, false),
    PAID_FEE("paid_fee", 3, false),
    ...
    private static final List<OrderBillColEnum> pks = (new ImmutableList.Builder<OrderBillColEnum>()).add(ID).build();

    private OrderBillColEnum(String name, int jdbcType, boolean pk) {
    ...
    public static List<OrderBillColEnum> getPKs() {
        return pks;
    }
}
