...
./commons-daemon-1.0.15-src/src/native/unix/jsvc \
  ...
  -pidfile ./pidfile.pid \
  -cp $CLASSPATH \
   com.dfire.tis.order.center.IndexSwapTaskflowLauncher
...
./commons-daemon-1.0.15-src/src/native/unix/jsvc  -cwd $WORK_HOME  -stop -pidfile ./pidfile.pid -cp $CLASSPATH com.dfire.tis.order.center.IndexSwapTaskflowLauncher  
