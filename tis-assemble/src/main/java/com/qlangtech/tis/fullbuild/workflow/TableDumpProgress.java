 ...
 * @date 2020/04/13
 */
public class TableDumpProgress {

    private ExecuteStatus state;

    private int datasourceTableId;

    public TableDumpProgress(int datasourceTableId) {
    ...
    public int getDatasourceTableId() {
        return datasourceTableId;
    }

    public void setDatasourceTableId(int datasourceTableId) {
        this.datasourceTableId = datasourceTableId;
    }
}
