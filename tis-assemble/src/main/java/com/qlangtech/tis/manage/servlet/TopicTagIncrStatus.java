...
//      });
        ...
        public int getPerSecRateNums() {
            return rateLimitState.getPerSecRateNums();
        }

        public short getControllerType() {
            return rateLimitState.getControllerType().map((controlType) -> controlType.getTypeToken()).orElseThrow();
        }


        public void setRateLimitConfig(LimitRateTypeAndRatePerSecNums rateLimitState) {
