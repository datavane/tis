...
public class TestStreamComponentCodeGeneratorFlink extends TestCase {
    ...
    public void testSingleTableCodeGenerator() throws Exception {
        ...
        DataXName collectionName = DataXName.createDataXPipeline("mysql_elastic");
...
//        }
        ...
        TestStreamComponentCodeGenerator
                .assertGenerateContentEqual(timestamp, collectionName.getPipelineName(), "MysqlElasticListener.scala");
