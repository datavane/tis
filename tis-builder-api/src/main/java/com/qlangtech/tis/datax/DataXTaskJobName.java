...
// **/
//public class DataXTaskJobName  //implements IDataXTaskRelevant
//{
//
//    public static JSONObject serialize(DataXTaskJobName item) {
//        JSONObject o = new JSONObject();
//        // return JSON.toJSONString(Objects.requireNonNull(item, "task message can not be null"), false);
//        //    item.getDataXName();
//        o.put(ITableDumpConstant.JOB_NAME, item.getJobName());
//        return o;
//    }
//
//    public static DataXTaskJobName deserialize(JSONObject json) {
//        DataXTaskJobName msg = new DataXTaskJobName();
//        final String jobName = json.getString(ITableDumpConstant.JOB_NAME);
