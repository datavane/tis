...
public class JobManagerAddress {
    ...
    public void telnet() throws SocketTimeoutException  {
        if (!NetUtils.isPortAvailable(this.host, this.port)) {
            throw new SocketTimeoutException("Address:" + this.host + ":" + this.port + " is not available");
        }
    }
