...
//    }
    ...
    protected abstract void executeSql(String sql, Connection conn) throws SQLException;

    protected abstract List<String> getHistoryPts(DataSourceMeta mrEngine, Connection conn, final EntityName table) throws Exception;
