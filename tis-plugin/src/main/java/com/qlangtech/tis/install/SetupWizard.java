...
//        // return new File(TIS.get().getRootDir(),"jenkins.install.UpgradeWizard.state");
...
//            return null;
//        }
//        return getPlatformPluginsForUpdate(version, TIS.get().getVersion());
//    }
//
//    /**
...
////        updateSiteList: for (UpdateSite updateSite : TIS.get().getUpdateCenter().getSiteList()) {
...
////            VersionNumber version = TIS.getVersion();
