...
/**
 * 估算目标属性的不同值数量（HyperLogLog 之类）。
 *
 * @author 百岁 (baisui@qlangtech.com)
 * @date 2026/5/10
 */
public class ApproxCardinalityAgg extends PropertyTargetedAgg {

    @Override
    public AggregationFunc kind() {
        return AggregationFunc.APPROX_CARDINALITY;
    }
    ...
    public static class DftDesc extends BasicDesc {
        ...
        public String getDisplayName() {
            return "Approximate cardinality";
        }
    }
}