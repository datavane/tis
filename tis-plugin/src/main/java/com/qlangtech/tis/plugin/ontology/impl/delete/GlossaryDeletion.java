 ...
 * @date 2026/5/18
 */
public class GlossaryDeletion extends BasicOntologyResourceDeletion {
    @Override
    protected Ontology.OntologyEnum getOntologyEnum() {
        return Ontology.OntologyEnum.Glossary;
    }
    @TISExtension
    public static class DefaultDesc extends BasicDeletionDesc {
        ...
        public final ListItemsManagerTargetResType parseTargetResType() {
            return ListItemsManagerTargetResType.OntologyGlossary;
        }
    }
}
