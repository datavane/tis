...
public class InferOntologyFromLLM extends OntologyDomainManipulate {
    ...
    public void manipuldateProcess(IPluginContext pluginContext, UploadPluginMeta pluginMeta,
        ...
        pluginContext.setBizResult(context.orElseThrow(), response.getJsonContent());
    }
    ...
    private TISJsonSchema buildLinkTypeItemSchema() {
    ...
    private TISJsonSchema buildSharedPropertyItemSchema() {
        TISJsonSchema.Builder b = TISJsonSchema.Builder.create("sharedPropertyItem", Optional.of("sharedProperties"));
    ...
    private TISJsonSchema buildValueTypeItemSchema() {
        TISJsonSchema.Builder b = TISJsonSchema.Builder.create("valueTypeItem", Optional.of("valueTypes"));
        b.addProperty("name", TISJsonSchema.FieldType.String, "值类型名称");
        b.addProperty("description", TISJsonSchema.FieldType.String, "值类型描述");
        b.addProperty("baseType", TISJsonSchema.FieldType.String, "基础类型（对应 OntologyType 枚举名）");
        b.addProperty("constraintType", TISJsonSchema.FieldType.String, "约束类型")
                .setValEnums("Enum4String", "Enum4Integer", "Range4String", "Range4Integer",
                        "Range4Decimal", "Range4TimeStamp", "Regex");
        b.addProperty("enumValues", TISJsonSchema.FieldType.Array, "枚举值列表（仅 Enum 约束时填写）")
                .setItems(TISJsonSchema.FieldType.String);
        b.addProperty("rangeMin", TISJsonSchema.FieldType.String, "范围最小值（仅 Range 约束时填写，可为空字符串）");
        b.addProperty("rangeMax", TISJsonSchema.FieldType.String, "范围最大值（仅 Range 约束时填写，可为空字符串）");
     ...
     */
    private TISJsonSchema buildGlossaryItemSchema() {
    ...
    public static void main(String[] args) {
        ...
        DescriptorsJSONForAIPrompt.AISchemaDescriptorsMeta descriptorsJSON1
        ...
        for (Map.Entry<String /* concrete plugin implement class */, Pair<TISJsonSchema, Descriptor>> entry :
            ...
            System.out.println(JsonUtil.toString(jsonSchema.root()));
        }
    }
