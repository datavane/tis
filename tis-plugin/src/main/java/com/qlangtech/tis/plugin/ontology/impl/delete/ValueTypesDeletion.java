 ...
 * @date 2026/5/18
 */
public class ValueTypesDeletion extends BasicOntologyResourceDeletion {

    @Override
    protected Ontology.OntologyEnum getOntologyEnum() {
        return Ontology.OntologyEnum.ValueType;
    }
    ...
    public static class DefaultDesc extends BasicDeletionDesc {
        ...
        public final ListItemsManagerTargetResType parseTargetResType() {
            return ListItemsManagerTargetResType.OntologyValueType;
        }
    }
}
