...
public class STConvertTokenizerFactory extends TokenizerFactory {
	...
	// public STConvertTokenizerFactory(IndexSettings indexSettings, Environment
	// env, String name, Settings settings) {
	...
	public Tokenizer create(AttributeFactory factory) {
		...
		STConvertTokenizer tokenizer //
				= new STConvertTokenizer(factory, convertType, delimiter, keepBoth);
