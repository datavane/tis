 ...
 */
public  final class PPhaseStatusCollection extends
    com.google.protobuf.GeneratedMessageV3 implements
    // @@protoc_insertion_point(message_implements:stream.PPhaseStatusCollection)
...
private static final long serialVersionUID = 0L;
  ...
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
    ...
    return com.qlangtech.tis.rpc.grpc.log.stream.LogCollectorProto.internal_static_stream_PPhaseStatusCollection_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            com.qlangtech.tis.rpc.grpc.log.stream.PPhaseStatusCollection.class, com.qlangtech.tis.rpc.grpc.log.stream.PPhaseStatusCollection.Builder.class);
  }
  ...
  public int getSerializedSize() {
    ...
    if (dumpPhase_ != null) {
      size += com.google.protobuf.CodedOutputStream
        .computeMessageSize(1, getDumpPhase());
    }
    if (joinPhase_ != null) {
      size += com.google.protobuf.CodedOutputStream
        .computeMessageSize(2, getJoinPhase());
    }
    if (buildPhase_ != null) {
      size += com.google.protobuf.CodedOutputStream
        .computeMessageSize(3, getBuildPhase());
    }
    if (indexBackFlowPhaseStatus_ != null) {
      size += com.google.protobuf.CodedOutputStream
        .computeMessageSize(4, getIndexBackFlowPhaseStatus());
    }
    if (taskId_ != 0) {
      size += com.google.protobuf.CodedOutputStream
        .computeUInt32Size(5, taskId_);
    }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (hasDumpPhase() != other.hasDumpPhase()) return false;
    if (hasDumpPhase()) {
      if (!getDumpPhase()
          .equals(other.getDumpPhase())) return false;
    }
    if (hasJoinPhase() != other.hasJoinPhase()) return false;
    if (hasJoinPhase()) {
      if (!getJoinPhase()
          .equals(other.getJoinPhase())) return false;
    }
    if (hasBuildPhase() != other.hasBuildPhase()) return false;
    if (hasBuildPhase()) {
      if (!getBuildPhase()
          .equals(other.getBuildPhase())) return false;
    }
    if (hasIndexBackFlowPhaseStatus() != other.hasIndexBackFlowPhaseStatus()) return false;
    if (hasIndexBackFlowPhaseStatus()) {
      if (!getIndexBackFlowPhaseStatus()
          .equals(other.getIndexBackFlowPhaseStatus())) return false;
    }
    if (getTaskId()
  ...
  public static com.qlangtech.tis.rpc.grpc.log.stream.PPhaseStatusCollection parseFrom(
  ...
  public static com.qlangtech.tis.rpc.grpc.log.stream.PPhaseStatusCollection parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static com.qlangtech.tis.rpc.grpc.log.stream.PPhaseStatusCollection parseFrom(
  ...
  public static com.qlangtech.tis.rpc.grpc.log.stream.PPhaseStatusCollection parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static com.qlangtech.tis.rpc.grpc.log.stream.PPhaseStatusCollection parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static com.qlangtech.tis.rpc.grpc.log.stream.PPhaseStatusCollection parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static final class Builder extends
      ...
      // @@protoc_insertion_point(builder_implements:stream.PPhaseStatusCollection)
    ...
    public Builder mergeFrom(com.qlangtech.tis.rpc.grpc.log.stream.PPhaseStatusCollection other) {
      if (other == com.qlangtech.tis.rpc.grpc.log.stream.PPhaseStatusCollection.getDefaultInstance()) return this;
    ...
    private com.google.protobuf.SingleFieldBuilderV3<
        com.qlangtech.tis.rpc.grpc.log.stream.PDumpPhaseStatus, com.qlangtech.tis.rpc.grpc.log.stream.PDumpPhaseStatus.Builder, com.qlangtech.tis.rpc.grpc.log.stream.PDumpPhaseStatusOrBuilder> dumpPhaseBuilder_;
    /**
     * <code>.stream.PDumpPhaseStatus dumpPhase = 1;</code>
     */
    public boolean hasDumpPhase() {
     ...
     * <code>.stream.PDumpPhaseStatus dumpPhase = 1;</code>
     */
    public Builder setDumpPhase(
        com.qlangtech.tis.rpc.grpc.log.stream.PDumpPhaseStatus.Builder builderForValue) {
      if (dumpPhaseBuilder_ == null) {
    ...
    public Builder mergeDumpPhase(com.qlangtech.tis.rpc.grpc.log.stream.PDumpPhaseStatus value) {
      if (dumpPhaseBuilder_ == null) {
        if (dumpPhase_ != null) {
          dumpPhase_ =
            com.qlangtech.tis.rpc.grpc.log.stream.PDumpPhaseStatus.newBuilder(dumpPhase_).mergeFrom(value).buildPartial();
        } else {
          dumpPhase_ = value;
        }
        onChanged();
    ...
    public com.qlangtech.tis.rpc.grpc.log.stream.PDumpPhaseStatusOrBuilder getDumpPhaseOrBuilder() {
      if (dumpPhaseBuilder_ != null) {
        ...
        return dumpPhase_ == null ?
            com.qlangtech.tis.rpc.grpc.log.stream.PDumpPhaseStatus.getDefaultInstance() : dumpPhase_;
      }
    }
    /**
     * <code>.stream.PDumpPhaseStatus dumpPhase = 1;</code>
     */
    private com.google.protobuf.SingleFieldBuilderV3<
        com.qlangtech.tis.rpc.grpc.log.stream.PDumpPhaseStatus, com.qlangtech.tis.rpc.grpc.log.stream.PDumpPhaseStatus.Builder, com.qlangtech.tis.rpc.grpc.log.stream.PDumpPhaseStatusOrBuilder> 
        getDumpPhaseFieldBuilder() {
      if (dumpPhaseBuilder_ == null) {
        dumpPhaseBuilder_ = new com.google.protobuf.SingleFieldBuilderV3<
            com.qlangtech.tis.rpc.grpc.log.stream.PDumpPhaseStatus, com.qlangtech.tis.rpc.grpc.log.stream.PDumpPhaseStatus.Builder, com.qlangtech.tis.rpc.grpc.log.stream.PDumpPhaseStatusOrBuilder>(
                getDumpPhase(),
    ...
    private com.qlangtech.tis.rpc.grpc.log.stream.PJoinPhaseStatus joinPhase_;
    private com.google.protobuf.SingleFieldBuilderV3<
        com.qlangtech.tis.rpc.grpc.log.stream.PJoinPhaseStatus, com.qlangtech.tis.rpc.grpc.log.stream.PJoinPhaseStatus.Builder, com.qlangtech.tis.rpc.grpc.log.stream.PJoinPhaseStatusOrBuilder> joinPhaseBuilder_;
    /**
     * <code>.stream.PJoinPhaseStatus joinPhase = 2;</code>
     */
    public boolean hasJoinPhase() {
     ...
     * <code>.stream.PJoinPhaseStatus joinPhase = 2;</code>
     */
    public Builder setJoinPhase(
        com.qlangtech.tis.rpc.grpc.log.stream.PJoinPhaseStatus.Builder builderForValue) {
      if (joinPhaseBuilder_ == null) {
    ...
    public Builder mergeJoinPhase(com.qlangtech.tis.rpc.grpc.log.stream.PJoinPhaseStatus value) {
      if (joinPhaseBuilder_ == null) {
        if (joinPhase_ != null) {
          joinPhase_ =
            com.qlangtech.tis.rpc.grpc.log.stream.PJoinPhaseStatus.newBuilder(joinPhase_).mergeFrom(value).buildPartial();
        } else {
          joinPhase_ = value;
        }
        onChanged();
    ...
    public com.qlangtech.tis.rpc.grpc.log.stream.PJoinPhaseStatusOrBuilder getJoinPhaseOrBuilder() {
      if (joinPhaseBuilder_ != null) {
        ...
        return joinPhase_ == null ?
            com.qlangtech.tis.rpc.grpc.log.stream.PJoinPhaseStatus.getDefaultInstance() : joinPhase_;
      }
    }
    /**
     * <code>.stream.PJoinPhaseStatus joinPhase = 2;</code>
     */
    private com.google.protobuf.SingleFieldBuilderV3<
        com.qlangtech.tis.rpc.grpc.log.stream.PJoinPhaseStatus, com.qlangtech.tis.rpc.grpc.log.stream.PJoinPhaseStatus.Builder, com.qlangtech.tis.rpc.grpc.log.stream.PJoinPhaseStatusOrBuilder> 
        getJoinPhaseFieldBuilder() {
      if (joinPhaseBuilder_ == null) {
        joinPhaseBuilder_ = new com.google.protobuf.SingleFieldBuilderV3<
            com.qlangtech.tis.rpc.grpc.log.stream.PJoinPhaseStatus, com.qlangtech.tis.rpc.grpc.log.stream.PJoinPhaseStatus.Builder, com.qlangtech.tis.rpc.grpc.log.stream.PJoinPhaseStatusOrBuilder>(
                getJoinPhase(),
                getParentForChildren(),
                isClean());
    ...
    private com.qlangtech.tis.rpc.grpc.log.stream.PBuildPhaseStatus buildPhase_;
    private com.google.protobuf.SingleFieldBuilderV3<
        com.qlangtech.tis.rpc.grpc.log.stream.PBuildPhaseStatus, com.qlangtech.tis.rpc.grpc.log.stream.PBuildPhaseStatus.Builder, com.qlangtech.tis.rpc.grpc.log.stream.PBuildPhaseStatusOrBuilder> buildPhaseBuilder_;
    /**
     * <code>.stream.PBuildPhaseStatus buildPhase = 3;</code>
     */
    public boolean hasBuildPhase() {
     ...
     * <code>.stream.PBuildPhaseStatus buildPhase = 3;</code>
     */
    public Builder setBuildPhase(
        com.qlangtech.tis.rpc.grpc.log.stream.PBuildPhaseStatus.Builder builderForValue) {
      if (buildPhaseBuilder_ == null) {
    ...
    public Builder mergeBuildPhase(com.qlangtech.tis.rpc.grpc.log.stream.PBuildPhaseStatus value) {
      if (buildPhaseBuilder_ == null) {
        if (buildPhase_ != null) {
          buildPhase_ =
            com.qlangtech.tis.rpc.grpc.log.stream.PBuildPhaseStatus.newBuilder(buildPhase_).mergeFrom(value).buildPartial();
        } else {
          buildPhase_ = value;
        }
        onChanged();
    ...
    public com.qlangtech.tis.rpc.grpc.log.stream.PBuildPhaseStatusOrBuilder getBuildPhaseOrBuilder() {
      if (buildPhaseBuilder_ != null) {
        ...
        return buildPhase_ == null ?
            com.qlangtech.tis.rpc.grpc.log.stream.PBuildPhaseStatus.getDefaultInstance() : buildPhase_;
      }
    }
    /**
     * <code>.stream.PBuildPhaseStatus buildPhase = 3;</code>
     */
    private com.google.protobuf.SingleFieldBuilderV3<
        com.qlangtech.tis.rpc.grpc.log.stream.PBuildPhaseStatus, com.qlangtech.tis.rpc.grpc.log.stream.PBuildPhaseStatus.Builder, com.qlangtech.tis.rpc.grpc.log.stream.PBuildPhaseStatusOrBuilder> 
        getBuildPhaseFieldBuilder() {
      if (buildPhaseBuilder_ == null) {
        buildPhaseBuilder_ = new com.google.protobuf.SingleFieldBuilderV3<
            com.qlangtech.tis.rpc.grpc.log.stream.PBuildPhaseStatus, com.qlangtech.tis.rpc.grpc.log.stream.PBuildPhaseStatus.Builder, com.qlangtech.tis.rpc.grpc.log.stream.PBuildPhaseStatusOrBuilder>(
                getBuildPhase(),
                getParentForChildren(),
                isClean());
    ...
    private com.qlangtech.tis.rpc.grpc.log.stream.PIndexBackFlowPhaseStatus indexBackFlowPhaseStatus_;
    private com.google.protobuf.SingleFieldBuilderV3<
        com.qlangtech.tis.rpc.grpc.log.stream.PIndexBackFlowPhaseStatus, com.qlangtech.tis.rpc.grpc.log.stream.PIndexBackFlowPhaseStatus.Builder, com.qlangtech.tis.rpc.grpc.log.stream.PIndexBackFlowPhaseStatusOrBuilder> indexBackFlowPhaseStatusBuilder_;
    /**
     * <code>.stream.PIndexBackFlowPhaseStatus indexBackFlowPhaseStatus = 4;</code>
     */
    public boolean hasIndexBackFlowPhaseStatus() {
     ...
     * <code>.stream.PIndexBackFlowPhaseStatus indexBackFlowPhaseStatus = 4;</code>
     */
    public Builder setIndexBackFlowPhaseStatus(
        com.qlangtech.tis.rpc.grpc.log.stream.PIndexBackFlowPhaseStatus.Builder builderForValue) {
      if (indexBackFlowPhaseStatusBuilder_ == null) {
    ...
    public Builder mergeIndexBackFlowPhaseStatus(com.qlangtech.tis.rpc.grpc.log.stream.PIndexBackFlowPhaseStatus value) {
      if (indexBackFlowPhaseStatusBuilder_ == null) {
        if (indexBackFlowPhaseStatus_ != null) {
          indexBackFlowPhaseStatus_ =
            com.qlangtech.tis.rpc.grpc.log.stream.PIndexBackFlowPhaseStatus.newBuilder(indexBackFlowPhaseStatus_).mergeFrom(value).buildPartial();
        } else {
          indexBackFlowPhaseStatus_ = value;
        }
        onChanged();
    ...
    public com.qlangtech.tis.rpc.grpc.log.stream.PIndexBackFlowPhaseStatusOrBuilder getIndexBackFlowPhaseStatusOrBuilder() {
      if (indexBackFlowPhaseStatusBuilder_ != null) {
        ...
        return indexBackFlowPhaseStatus_ == null ?
            com.qlangtech.tis.rpc.grpc.log.stream.PIndexBackFlowPhaseStatus.getDefaultInstance() : indexBackFlowPhaseStatus_;
      }
    }
    /**
     * <code>.stream.PIndexBackFlowPhaseStatus indexBackFlowPhaseStatus = 4;</code>
     */
    private com.google.protobuf.SingleFieldBuilderV3<
        com.qlangtech.tis.rpc.grpc.log.stream.PIndexBackFlowPhaseStatus, com.qlangtech.tis.rpc.grpc.log.stream.PIndexBackFlowPhaseStatus.Builder, com.qlangtech.tis.rpc.grpc.log.stream.PIndexBackFlowPhaseStatusOrBuilder> 
        getIndexBackFlowPhaseStatusFieldBuilder() {
      if (indexBackFlowPhaseStatusBuilder_ == null) {
        indexBackFlowPhaseStatusBuilder_ = new com.google.protobuf.SingleFieldBuilderV3<
            com.qlangtech.tis.rpc.grpc.log.stream.PIndexBackFlowPhaseStatus, com.qlangtech.tis.rpc.grpc.log.stream.PIndexBackFlowPhaseStatus.Builder, com.qlangtech.tis.rpc.grpc.log.stream.PIndexBackFlowPhaseStatusOrBuilder>(
  ...
  private static final com.google.protobuf.Parser<PPhaseStatusCollection>
      PARSER = new com.google.protobuf.AbstractParser<PPhaseStatusCollection>() {
    @java.lang.Override
    public PPhaseStatusCollection parsePartialFrom(
        com.google.protobuf.CodedInputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws com.google.protobuf.InvalidProtocolBufferException {
