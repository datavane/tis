...
public  final class TopicInfo extends
    ...
    // @@protoc_insertion_point(message_implements:rpc.TopicInfo)
    TopicInfoOrBuilder {
private static final long serialVersionUID = 0L;
      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 10: {
            ...
            topicWithTags_.add(
                input.readMessage(com.qlangtech.tis.grpc.LaunchReportInfoEntry.parser(), extensionRegistry));
            break;
          }
          default: {
  ...
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
    ...
    return com.qlangtech.tis.grpc.IncrStatusProto.internal_static_rpc_TopicInfo_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            com.qlangtech.tis.grpc.TopicInfo.class, com.qlangtech.tis.grpc.TopicInfo.Builder.class);
  }
   ...
   * <code>repeated .rpc.LaunchReportInfoEntry topicWithTags = 1;</code>
   */
  public java.util.List<? extends com.qlangtech.tis.grpc.LaunchReportInfoEntryOrBuilder> 
   ...
   * <code>repeated .rpc.LaunchReportInfoEntry topicWithTags = 1;</code>
   */
  public com.qlangtech.tis.grpc.LaunchReportInfoEntryOrBuilder getTopicWithTagsOrBuilder(
      int index) {
    return topicWithTags_.get(index);
  }
  ...
  public int getSerializedSize() {
    ...
    for (int i = 0; i < topicWithTags_.size(); i++) {
      size += com.google.protobuf.CodedOutputStream
        .computeMessageSize(1, topicWithTags_.get(i));
    }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!getTopicWithTagsList()
        .equals(other.getTopicWithTagsList())) return false;
  ...
  public static com.qlangtech.tis.grpc.TopicInfo parseFrom(
  ...
  public static com.qlangtech.tis.grpc.TopicInfo parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static com.qlangtech.tis.grpc.TopicInfo parseFrom(
  ...
  public static com.qlangtech.tis.grpc.TopicInfo parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static com.qlangtech.tis.grpc.TopicInfo parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static com.qlangtech.tis.grpc.TopicInfo parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static final class Builder extends
      ...
      // @@protoc_insertion_point(builder_implements:rpc.TopicInfo)
    ...
    public Builder mergeFrom(com.qlangtech.tis.grpc.TopicInfo other) {
      if (other == com.qlangtech.tis.grpc.TopicInfo.getDefaultInstance()) return this;
      if (topicWithTagsBuilder_ == null) {
        ...
        if (!other.topicWithTags_.isEmpty()) {
          if (topicWithTagsBuilder_.isEmpty()) {
            ...
            topicWithTags_ = other.topicWithTags_;
            bitField0_ = (bitField0_ & ~0x00000001);
            topicWithTagsBuilder_ = 
              com.google.protobuf.GeneratedMessageV3.alwaysUseFieldBuilders ?
                 getTopicWithTagsFieldBuilder() : null;
          } else {
    ...
    private com.google.protobuf.RepeatedFieldBuilderV3<
        com.qlangtech.tis.grpc.LaunchReportInfoEntry, com.qlangtech.tis.grpc.LaunchReportInfoEntry.Builder, com.qlangtech.tis.grpc.LaunchReportInfoEntryOrBuilder> topicWithTagsBuilder_;
     ...
     * <code>repeated .rpc.LaunchReportInfoEntry topicWithTags = 1;</code>
     */
    public Builder setTopicWithTags(
        int index, com.qlangtech.tis.grpc.LaunchReportInfoEntry value) {
      if (topicWithTagsBuilder_ == null) {
        if (value == null) {
     ...
     */
    public Builder setTopicWithTags(
        int index, com.qlangtech.tis.grpc.LaunchReportInfoEntry.Builder builderForValue) {
      if (topicWithTagsBuilder_ == null) {
        ensureTopicWithTagsIsMutable();
     ...
     * <code>repeated .rpc.LaunchReportInfoEntry topicWithTags = 1;</code>
     */
    public Builder addTopicWithTags(
        int index, com.qlangtech.tis.grpc.LaunchReportInfoEntry value) {
      if (topicWithTagsBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
     ...
     */
    public Builder addTopicWithTags(
        com.qlangtech.tis.grpc.LaunchReportInfoEntry.Builder builderForValue) {
      if (topicWithTagsBuilder_ == null) {
        ensureTopicWithTagsIsMutable();
     ...
     * <code>repeated .rpc.LaunchReportInfoEntry topicWithTags = 1;</code>
     */
    public Builder addAllTopicWithTags(
        java.lang.Iterable<? extends com.qlangtech.tis.grpc.LaunchReportInfoEntry> values) {
      if (topicWithTagsBuilder_ == null) {
        ensureTopicWithTagsIsMutable();
        com.google.protobuf.AbstractMessageLite.Builder.addAll(
            values, topicWithTags_);
        onChanged();
      } else {
     ...
     * <code>repeated .rpc.LaunchReportInfoEntry topicWithTags = 1;</code>
     */
    public com.qlangtech.tis.grpc.LaunchReportInfoEntry.Builder getTopicWithTagsBuilder(
        int index) {
    ...
    public com.qlangtech.tis.grpc.LaunchReportInfoEntryOrBuilder getTopicWithTagsOrBuilder(
        int index) {
      if (topicWithTagsBuilder_ == null) {
        return topicWithTags_.get(index);  } else {
    ...
    public com.qlangtech.tis.grpc.LaunchReportInfoEntry.Builder addTopicWithTagsBuilder() {
      return getTopicWithTagsFieldBuilder().addBuilder(
          com.qlangtech.tis.grpc.LaunchReportInfoEntry.getDefaultInstance());
    }
    /**
     * <code>repeated .rpc.LaunchReportInfoEntry topicWithTags = 1;</code>
     */
    public com.qlangtech.tis.grpc.LaunchReportInfoEntry.Builder addTopicWithTagsBuilder(
        int index) {
      return getTopicWithTagsFieldBuilder().addBuilder(
          index, com.qlangtech.tis.grpc.LaunchReportInfoEntry.getDefaultInstance());
    }
    /**
     * <code>repeated .rpc.LaunchReportInfoEntry topicWithTags = 1;</code>
     */
    public java.util.List<com.qlangtech.tis.grpc.LaunchReportInfoEntry.Builder> 
         getTopicWithTagsBuilderList() {
      return getTopicWithTagsFieldBuilder().getBuilderList();
    }
    private com.google.protobuf.RepeatedFieldBuilderV3<
        com.qlangtech.tis.grpc.LaunchReportInfoEntry, com.qlangtech.tis.grpc.LaunchReportInfoEntry.Builder, com.qlangtech.tis.grpc.LaunchReportInfoEntryOrBuilder> 
        getTopicWithTagsFieldBuilder() {
      if (topicWithTagsBuilder_ == null) {
        topicWithTagsBuilder_ = new com.google.protobuf.RepeatedFieldBuilderV3<
            com.qlangtech.tis.grpc.LaunchReportInfoEntry, com.qlangtech.tis.grpc.LaunchReportInfoEntry.Builder, com.qlangtech.tis.grpc.LaunchReportInfoEntryOrBuilder>(
                topicWithTags_,
